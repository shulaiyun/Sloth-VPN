...
use App\Http\Controllers\V1\User\AssistantController;
...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            // Assistant
            $router->post('/assistant/chat', [AssistantController::class, 'chat']);
            $router->post('/assistant/ticket-handoff', [AssistantController::class, 'ticketHandoff']);
            // Stat
