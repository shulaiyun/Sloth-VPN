...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'ios_download_url' => '',
        'ios_guide_title' => '',
        'ios_guide_url' => 'nullable|url',
        'ios_guide_markdown' => 'nullable',
        'assistant_enabled' => 'boolean',
        'assistant_provider' => '',
        'assistant_base_url' => 'nullable|url',
        'assistant_model' => '',
        'assistant_api_key' => '',
        'assistant_system_prompt' => 'nullable',
        'assistant_ticket_handoff_enable' => 'boolean',
        // safe
    ...
    public function messages()
    {
        ...
        return [
            ...
            'ios_guide_url.url' => 'iOS 教程链接格式不正确，必须携带http(s)://',
            'assistant_base_url.url' => '智能助手地址格式不正确，必须携带http(s)://',
