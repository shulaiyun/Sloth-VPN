...
class ConfigController extends Controller
{
    ...
    private function getConfigMappings(): array
    {
        return [
            ...
            'frontend' => [
                'frontend_theme' => admin_setting('frontend_theme', 'SlothPro'),
            ...
            'app' => [
                ...
                'ios_guide_title' => admin_setting('ios_guide_title', 'iOS 安装教程'),
                'ios_guide_url' => admin_setting('ios_guide_url', ''),
                'ios_guide_markdown' => admin_setting('ios_guide_markdown', ''),
                'assistant_enabled' => (bool) admin_setting('assistant_enabled', true),
                'assistant_provider' => admin_setting('assistant_provider', 'cliproxyapi'),
                'assistant_base_url' => admin_setting('assistant_base_url', ''),
                'assistant_model' => admin_setting('assistant_model', 'gpt-4o-mini'),
                'assistant_api_key' => admin_setting('assistant_api_key', ''),
                'assistant_system_prompt' => admin_setting('assistant_system_prompt', ''),
                'assistant_ticket_handoff_enable' => (bool) admin_setting('assistant_ticket_handoff_enable', true),
            ],
            'safe' => [
